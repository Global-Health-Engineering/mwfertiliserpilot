...
Maize plays a central role in Malawi, yet best practices regarding its cultivation are rarely followed. Too much fertilizer (if available) is used per planting station, spacing between and across planting stations varies widely and the appropriate seeds are rarely used. 
