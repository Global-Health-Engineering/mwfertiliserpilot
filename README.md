...
cultivation are rarely followed. Too much fertilizer (if available) is
used per planting station, spacing between and across planting stations
varies widely and the appropriate seeds are rarely used.
